import { ScheduleComponent, ViewsDirective, ViewDirective, ResourcesDirective, ResourceDirective, TimelineMonth, Resize, DragAndDrop, Inject } from '@syncfusion/ej2-react-schedule';

const VirtualScrollingSchedule = () => {

    let scheduleObj: any;

    const generateStaticEvents = (start: any, resCount: any, overlapCount: any) =>  {
        let data = [];
        let id = 1;
    ...
    const generateResourceData = (startId: any, endId: any, text: any) => {
        let data = [];
        let colors = [
    ...
    return (
        <ScheduleComponent cssClass='virtual-scrolling' ref={schedule => scheduleObj = schedule} width='100%' height='550px' selectedDate={new Date(2018, 4, 1)} eventSettings={{
...
export default VirtualScrollingSchedule;
